...
From the cross-validation we quantified \emph{Root Mean Squared Error}.
...
By itself, \emph{DMK class} produced a concordance correlation coefficient of 0.17 (compared to 0.008 at Skrimfjella), but the worst RMSE of any model at either site: \unit{98\,cm}.
