...
\item
  radiometric and terrain predictors (25 continuous variables)
\item
...
While the primary aim of the DSM was to predict peat depth within peatlands (where peat \textgreater{} 30 cm), we also performed a minimal evaluation of our ability to estimate peat depth outside of mapped peatland.
...
For the top six most important variables, we plotted both partial dependence and individual conditional expectation (ICE), to show the average effect of the predictor on the outcome and the variation in the effect across observations, repectively \citep{goldsteinPeekingBlackBox2015}.
