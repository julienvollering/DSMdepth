...
To try to avoid confusion on this point, we have added a short explanation in the _Materials and methods_ section that the distinction between counts per second and concentration is not relevant for our analysis and it does not affect the predictive power of the radiometric variables in our models.
