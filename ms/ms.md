...
From the cross-validation we quantified mean absolute error (accuracy, original scale), R^2^ (correlation, standardized scale), and Lin's concordance correlation coefficient (accuracy and correlation, standardized scale).
...
The best models at both sites strongly underpredicted the deepest peats (Fig. \@ref(fig:calPlots)).
